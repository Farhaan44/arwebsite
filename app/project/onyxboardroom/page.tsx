...
const PROJECT = {
  ...
  tagline: "Crafted for quiet executive authority",
  year: "2026",
  location: "Agripada, Mumbai",
  services: ["Commercial Space Designing", "Management"],
  heroImage: "/onyxboardroom.jpg", 
  imageTwo: "/onyxboardroom3.jpg",
  imageThree: "/onyxboardroom2.jpeg",
  description:
    "Designed as the strategic heart of a corporate headquarters, The Onyx Boardroom centers around a massive, internally illuminated onyx marble table. The surrounding space is wrapped in warm acoustic timber veneers and outfitted with hand-stitched leather seating. The result is an environment that balances intense focus with sophisticated warmth, ensuring that every detail reflects absolute professionalism and uncompromising quality.",
};
