...
const PROJECT = {
  ...
  tagline: "Luminous veining meets spatial serenity",
  year: "2022",
  location: "Tardeo, Mumbai",
  services: ["Interior Designing","Material Sourcing"],
  heroImage: "/partner3.jpg", 
  imageTwo: "/marblesanct3.jpg",
  imageThree: "/marblesanc2.jpg",
  description:
    "This private residence is defined by its seamless integration of book-matched Italian Statuario marble across continuous architectural lines. Rather than treating stone merely as a surface finish, it was applied as a primary spatial anchor, allowing natural daylight to trace its complex veining. Coupled with minimalist fixtures and warm ambient lighting, the home acts as a quiet, grounded retreat from the outside world.",
};
