...
const PROJECT = {
  title: "The Sky Suite",
  tagline: "Dissolving the boundary between space and sky.",
  year: "2022",
  location: "Tardeo, Mumbai",
  services: ["Commercial Space Designing", "Management"],
  heroImage: "/skysuite.jpeg", 
  imageTwo: "/skysuite3.jpg",
  imageThree: "/skysuite2.jpg",
  description:
    "Perched at the apex of the city, The Sky Suite is a masterclass in atmospheric interior architecture. The design intent was to pull the horizon inward, utilizing reflective surfaces, minimalist framing, and a muted, earthy palette to ensure the view remains the primary focal point. It is a residence that changes dynamically with the time of day, bathed in natural light and grounded by bespoke, low-profile furnishings.",
};
