...
const PROJECT = {
  title: "Numara",
  tagline: "The design of quiet opulence",
  year: "2026",
  location: "Agripada, Mumbai",
  services: ["Commercial Space Designing", "Management"],
  heroImage: "/work3.jpg", 
  imageTwo: "/numara2.jpeg",
  imageThree: "/numara3.jpg",
  description:
    "This work redefines the modern commercial environment through a masterful balance of materiality. By pairing luminous onyx and intensely veined Statuario marble with rich, hand-polished wood veneers, the space transitions from corporate utility to tactile luxury. The design language speaks in whispers—relying on flawless joinery, strict geometric alignment, and dramatic ambient lighting rather than overt ornamentation.",
};
