...
const PROJECT = {
  ...
  tagline: "Tactile warmth in a corporate landscape",
  year: "2026",
  location: "Agripada, Mumbai",
  services: ["Designing","Material Sourcing","Management"],
  heroImage: "/veneercabin2.jpg", 
  imageTwo: "/veneercabin.jpg",
  imageThree: "/veneercabin3.jpeg",
  description:
    "A deliberate departure from cold corporate interiors, this executive cabin is completely enveloped in rich architectural veneer paneling and flawless bespoke joinery. The space was designed to foster both deep, isolated focus and intimate client conversations. By carefully controlling sightlines, lighting, and acoustics, the cabin functions as a personal sanctuary that commands respect through subtle, meticulous craftsmanship.",
};
