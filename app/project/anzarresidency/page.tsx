...
const PROJECT = {
  ...
  tagline: "A study in vertical serenity.",
  year: "2018",
  location: "Agripada, Mumbai",
  services: ["Structural Designing", "Space Planning", "Management"],
  heroImage: "/work1.jpg", 
  imageTwo: "/anzarelegancenight.png",
  imageThree: "/anzarelegancehd.jpg",
  description:
    "Anzar Residency was conceived as an architectural statement rising twenty-one stories above the urban canopy. The challenge was not just to build tall, but to build quietly. Every aperture, every material transition, and every structural column was designed to diffuse the chaos of the city outside, framing sweeping ocean vistas while maintaining an atmosphere of uncompromising internal comfort. By utilizing raw lime washes and monolithic stone, the space is designed to age gracefully.",
};
